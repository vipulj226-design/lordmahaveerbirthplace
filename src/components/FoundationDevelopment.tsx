...
export default function FoundationDevelopment() {
  ...
  return (
    <section id="foundation" className="relative pt-6 md:pt-8 pb-8 md:pb-12 bg-cream overflow-hidden border-b-[3px] border-gold">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
                      {block.galleryImage1 && (
                        <motion.div
                          ...
                          whileInView={{ opacity: 1, scale: 1 }}
                          viewport={{ once: true }}
                          className="rounded-lg overflow-hidden border-2 border-gold/40 hover:border-gold transition-colors duration-300 bg-cream h-80"
                        >
                          <Image
