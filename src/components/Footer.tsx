      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-3">
            <p className="text-foreground text-3xl font-paragraph font-bold bg-gold py-3 px-6 rounded-lg inline-block mx-auto text-primary-foreground">
              WEBSITE DESIGNED & MANAGED BY
            </p>
            <h2 className="text-foreground text-3xl font-paragraph font-bold">
              VIPUL JAIN
            </h2>
            <p className="text-foreground text-3xl font-paragraph font-bold bg-gold py-3 px-6 rounded-lg inline-block mx-auto text-primary-foreground">
              💬 WHATSAPP: 8470990283
