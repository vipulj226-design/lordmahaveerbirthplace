  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.h1 
          className="font-heading font-black tracking-tight mb-6 mt-16 md:mt-0 text-3xl px-4"
          style={{
      ...
      >
        <p className="font-paragraph text-xs text-cream/70 uppercase tracking-widest">
          Scroll to explore
        </p>
        <motion.div
          animate={{ y: [0, 8, 0] }}
