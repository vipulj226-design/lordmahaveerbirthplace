  ...
  return (
    <section id="about" ref={sectionRef} className="relative pt-4 md:pt-12 pb-4 md:pb-40 bg-cream overflow-hidden">
      <div className="w-full max-w-[120rem] mx-auto px-6 lg:px-12">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="group relative bg-gradient-to-br from-cream to-cream/90 border-2 border-gold p-6 md:p-12 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden -mt-8 mb-2 md:mb-4">
