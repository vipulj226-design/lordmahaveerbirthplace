      ...
      >
        <motion.a 
          ...
          style={{
            ...
            fontWeight: 900,
            boxShadow: '0 12px 35px rgba(220, 20, 60, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
          ...
          whileHover={{ 
            y: -6, 
            boxShadow: '0 20px 50px rgba(220, 20, 60, 0.8), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
            scale: 1.08
          }}
          whileTap={{ scale: 0.98 }}
        >
