...
import { ArrowRight, MapPin, Calendar, Users, Scroll, Star, ChevronDown, X, ChevronLeft, ChevronRight, MessageCircle, Clock, Building2, Youtube } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <div 
      ...
      style={{ scrollPaddingTop: 'clamp(80px, 15vh, 600px)' }}
    >
      {/* --- HEADER --- */}
      <Header />
      {/* --- HERO SECTION --- */}
...
function HeroSection() {
  ...
  const backgroundImage = heroContent?.backgroundImage || 'https://static.wixstatic.com/media/53945f_a4195685dc67436e92a6c31eb31c2755~mv2.webp';
...
function BirthplaceAboutSection() {
  ...
  return (
    <section id="about" ref={sectionRef} className="relative pt-4 md:pt-12 pb-4 md:pb-16 bg-cream overflow-hidden border-b-[3px] border-gold">
      <div className="w-full max-w-[120rem] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-8 md:mb-32 relative">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="font-heading text-3xl md:text-6xl font-black text-maroon uppercase tracking-tight relative z-10 leading-tight lg:text-5xl mb-6 md:mb-12"
          >
            The Sacred <br/>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="group relative bg-gradient-to-br from-cream to-cream/90 border-2 border-gold p-6 md:p-12 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden -mt-16 mb-2 md:mb-4">
        ...
        <div className="border-t-2 border-gold/30 mb-4 md:px-[67px] md:py-8 -mt-4">
          <motion.h3
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
              ...
              <div className="lg:col-span-5 relative order-2 lg:order-1 mt-8 lg:mt-0">
                <div className="sticky top-32">
                  <div className="relative aspect-[3/4] w-full overflow-hidden border-4 border-maroon bg-maroon">
                    <Image
                      src="https://static.wixstatic.com/media/53945f_87815bf91fcf4457a966444d95542575~mv2.jpg"
...
function BlessingsSection() {
  ...
  return (
    <section id="blessings" className="relative py-3 md:py-6 bg-cream overflow-hidden border-b-[3px] border-gold">
      <div className="w-full max-w-[120rem] mx-auto px-6 lg:px-12">
...
function StatisticsSection() {
  ...
  return (
    <section id="statistics" ref={statsRef} className="relative bg-maroon py-6 md:py-8 overflow-hidden pt-6 md:pt-8 border-b-[3px] border-gold">
      {/* Background Texture */}
                ...
                >
                  ...
                  {image.caption && (
                    <div className="absolute inset-0 bg-gradient-to-t from-maroon/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                      <p className="font-paragraph text-cream text-sm">{image.caption}</p>
                    </div>
                  )}
                </motion.div>
              ))}
...
function UpcomingEventsSection() {
  ...
  return (
    <section id="events" ref={sectionRef} className="relative py-4 md:py-12 bg-cream overflow-hidden border-b-[3px] border-gold">
      <div className="w-full max-w-[120rem] mx-auto px-6 lg:px-12">
...
function HowToReachSection() {
  ...
  return (
    <section id="how-to-reach" className="relative py-4 md:py-12 bg-cream overflow-hidden border-b-[3px] border-gold">
      <div className="w-full max-w-[120rem] mx-auto px-6 lg:px-12">
...
function ContactSection() {
  return (
    <section id="contact" className="relative py-0 md:py-12 bg-cream overflow-hidden border-b-[3px] border-gold">
      <div className="w-full max-w-[120rem] mx-auto px-6 lg:px-12 py-8 md:py-0">
