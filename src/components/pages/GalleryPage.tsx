      ...
      {lightboxOpen && allLightboxImages.length > 0 && (
        ...
        >
          <div className="relative w-full h-full flex flex-col items-center justify-center" onClick={(e) => e.stopPropagation()}>
            ...
            {/* Image Container */}
            <div className="flex items-center justify-center w-full flex-1 overflow-auto">
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="w-auto h-auto max-w-[90vw] sm:max-w-[80vw] md:max-w-[70vw] flex items-center justify-center border-4 border-gold rounded-lg bg-black/20 p-2 sm:p-4">
                    <Image 
                      src={allLightboxImages[currentImageIndex]} 
                      alt="Gallery image" 
                      className="w-auto h-auto max-w-full max-h-[85vh] sm:max-h-[75vh] object-contain"
                    />
                  </div>
                </motion.div>
              </AnimatePresence>
