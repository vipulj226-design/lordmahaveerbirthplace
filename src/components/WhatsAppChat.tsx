  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      ...
      <motion.button
        ...
        className="flex flex-col items-center justify-center w-20 h-20 bg-gradient-to-br from-[#25D366] to-[#20BA5A] hover:from-[#20BA5A] hover:to-[#1a8c4a] text-white rounded-full shadow-2xl transition-all duration-300 border-4 border-white"
      ...
      >
        {isOpen ? (
          ...
          <>
            ...
            <span className="font-heading text-xs font-bold uppercase tracking-widest">Live Chat</span>
          </>
        )}
      </motion.button>
    </div>
